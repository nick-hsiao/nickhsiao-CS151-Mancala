...
//----------------Setting up the BSide Pits and its StoneClusters--------------------------------
		...
		for(int i = 12; i >= 7; i--)
		{
			...
			StoneCluster stones = new StoneCluster(4, i, PlayerLetter.B); //starting number of stones and index in array
...
//-----------Setting up Mancala B and its StoneClusters--------------------------------------
		...
		StoneCluster stonesManB = new StoneCluster(0, 13, PlayerLetter.B);		//Mancala starts empty
...
//----------------Setting up the ASide Pits and its StoneClusters------------------------------		
		...
		for(int i = 0; i <= 5; i++)
		{
			...
			final ShapePanel jPit = new ShapePanel(pit);
			jPit.setLayout(new BorderLayout());
			StoneCluster stones = new StoneCluster(4, i, PlayerLetter.A); //starting number of stones and index in array
			GameIcon iconStones = new GameIcon(stones);
			final GameLabel jStones = new GameLabel(iconStones, stones);
			jPit.add(BorderLayout.CENTER, jStones);
			//Add mouse Listener
...
//-----------Setting up Mancala A and its StoneClusters--------------------------------------
		...
		StoneCluster stonesManA = new StoneCluster(0, 6, PlayerLetter.A);		//Mancala starts empty
